 ...
 * @author aruna
 */
public class ScenarioGenPutGet {
    
    public static int nNumNodes = 5;
    public static int nFDTimout = 4000;
    
    static Operation1 startTrackerOp = (Operation1<StartNodeEvent, Integer>)
            (final Integer node) -> new StartNodeEvent() {
   ...
   static Operation1 startNodeOp = (Operation1<StartNodeEvent,Integer>) 
           (final Integer self) -> new StartNodeEvent() {
   ...
   static Operation1 startClientOp = (Operation1<StartNodeEvent,Integer>) 
           (final Integer self) -> new StartNodeEvent() {
    ...
    public static SimulationScenario simplePutGetRequestScenario() {
